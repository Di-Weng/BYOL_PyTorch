...
class OssImageLoader():
    def __init__(self, config):
        self.endpoint = config['data']['oss']['endpoint']
        self.key_id = config['data']['oss']['key_id']
        self.secret_id = config['data']['oss']['secret_id']
        self.bucket = config['data']['oss']['bucket']
        self.train_list = config['data']['oss']['train_list']
        self.val_list = config['data']['oss']['val_list']
